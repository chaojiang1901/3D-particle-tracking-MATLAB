function [DF,AlphaF,DL,AlphaL]=MSDtrack1dF4LDAjc(msd,D_MSDSize,Alpha_MSDSize,TimeResolution);
    %D_MSDSize=3;     
    dt1=(1:100)*TimeResolution; dt=dt1';
    %ft_ = fittype('poly1');
    x=dt(1:D_MSDSize);y=msd(1:D_MSDSize);
    [fitresultF, gofF] = createFitKbDalphaJC2(x, y); %JC1 MSD=d*t^a+c;
...
%     RsquareF = gof.rsquare;
    ...
    [fitresultL, gofL] = createFitKbDalphaJC2(x1, y1);
